...
public class ArrayUtilsTest {
    ...
    public void testFindLastEmpty() {
        // For any input where y appears in the second or later position, there is no
        // error. Also,
    ...
    public void testOddOrPosAllPositives() {
        // Any nonempty x with only non-negative elements works, because the first part
        // of the
    ...
    @Test
    public void testCountOfNullArray() {
        assertThrows(NullPointerException.class, () -> {
